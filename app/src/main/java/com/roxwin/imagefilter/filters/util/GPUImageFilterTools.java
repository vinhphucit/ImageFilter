...
import com.roxwin.imagefilter.filters.GPUImage3x3ConvolutionFilter;
import com.roxwin.imagefilter.filters.GPUImage3x3TextureSamplingFilter;
import com.roxwin.imagefilter.filters.GPUImageAddBlendFilter;
import com.roxwin.imagefilter.filters.GPUImageAlphaBlendFilter;
import com.roxwin.imagefilter.filters.GPUImageBilateralFilter;
import com.roxwin.imagefilter.filters.GPUImageBoxBlurFilter;
import com.roxwin.imagefilter.filters.GPUImageBrightnessFilter;
import com.roxwin.imagefilter.filters.GPUImageBulgeDistortionFilter;
import com.roxwin.imagefilter.filters.GPUImageCGAColorspaceFilter;
import com.roxwin.imagefilter.filters.GPUImageChromaKeyBlendFilter;
import com.roxwin.imagefilter.filters.GPUImageColorBalanceFilter;
import com.roxwin.imagefilter.filters.GPUImageColorBlendFilter;
import com.roxwin.imagefilter.filters.GPUImageColorBurnBlendFilter;
import com.roxwin.imagefilter.filters.GPUImageColorDodgeBlendFilter;
import com.roxwin.imagefilter.filters.GPUImageColorInvertFilter;
import com.roxwin.imagefilter.filters.GPUImageContrastFilter;
import com.roxwin.imagefilter.filters.GPUImageCrosshatchFilter;
import com.roxwin.imagefilter.filters.GPUImageDarkenBlendFilter;
import com.roxwin.imagefilter.filters.GPUImageDifferenceBlendFilter;
import com.roxwin.imagefilter.filters.GPUImageDilationFilter;
import com.roxwin.imagefilter.filters.GPUImageDirectionalSobelEdgeDetectionFilter;
import com.roxwin.imagefilter.filters.GPUImageDissolveBlendFilter;
import com.roxwin.imagefilter.filters.GPUImageDivideBlendFilter;
import com.roxwin.imagefilter.filters.GPUImageEmbossFilter;
import com.roxwin.imagefilter.filters.GPUImageExclusionBlendFilter;
import com.roxwin.imagefilter.filters.GPUImageExposureFilter;
import com.roxwin.imagefilter.filters.GPUImageFalseColorFilter;
import com.roxwin.imagefilter.filters.GPUImageFilter;
import com.roxwin.imagefilter.filters.GPUImageFilterGroup;
import com.roxwin.imagefilter.filters.GPUImageGammaFilter;
import com.roxwin.imagefilter.filters.GPUImageGaussianBlurFilter;
import com.roxwin.imagefilter.filters.GPUImageGlassSphereFilter;
import com.roxwin.imagefilter.filters.GPUImageGrayscaleFilter;
import com.roxwin.imagefilter.filters.GPUImageHalftoneFilter;
import com.roxwin.imagefilter.filters.GPUImageHardLightBlendFilter;
import com.roxwin.imagefilter.filters.GPUImageHazeFilter;
import com.roxwin.imagefilter.filters.GPUImageHighlightShadowFilter;
import com.roxwin.imagefilter.filters.GPUImageHueBlendFilter;
import com.roxwin.imagefilter.filters.GPUImageHueFilter;
import com.roxwin.imagefilter.filters.GPUImageKuwaharaFilter;
import com.roxwin.imagefilter.filters.GPUImageLaplacianFilter;
import com.roxwin.imagefilter.filters.GPUImageLevelsFilter;
import com.roxwin.imagefilter.filters.GPUImageLightenBlendFilter;
import com.roxwin.imagefilter.filters.GPUImageLinearBurnBlendFilter;
import com.roxwin.imagefilter.filters.GPUImageLookupFilter;
import com.roxwin.imagefilter.filters.GPUImageLuminosityBlendFilter;
import com.roxwin.imagefilter.filters.GPUImageMonochromeFilter;
import com.roxwin.imagefilter.filters.GPUImageMultiplyBlendFilter;
import com.roxwin.imagefilter.filters.GPUImageNonMaximumSuppressionFilter;
import com.roxwin.imagefilter.filters.GPUImageNormalBlendFilter;
import com.roxwin.imagefilter.filters.GPUImageNormalFilter;
import com.roxwin.imagefilter.filters.GPUImageOpacityFilter;
import com.roxwin.imagefilter.filters.GPUImageOverlayBlendFilter;
import com.roxwin.imagefilter.filters.GPUImagePixelationFilter;
import com.roxwin.imagefilter.filters.GPUImagePosterizeFilter;
import com.roxwin.imagefilter.filters.GPUImageRGBDilationFilter;
import com.roxwin.imagefilter.filters.GPUImageRGBFilter;
import com.roxwin.imagefilter.filters.GPUImageSaturationBlendFilter;
import com.roxwin.imagefilter.filters.GPUImageSaturationFilter;
import com.roxwin.imagefilter.filters.GPUImageScreenBlendFilter;
import com.roxwin.imagefilter.filters.GPUImageSepia2Filter;
import com.roxwin.imagefilter.filters.GPUImageSepia3Filter;
import com.roxwin.imagefilter.filters.GPUImageSepia4Filter;
import com.roxwin.imagefilter.filters.GPUImageSepiaFilter;
import com.roxwin.imagefilter.filters.GPUImageSharpenFilter;
import com.roxwin.imagefilter.filters.GPUImageSketchFilter;
import com.roxwin.imagefilter.filters.GPUImageSmoothToonFilter;
import com.roxwin.imagefilter.filters.GPUImageSobelEdgeDetection;
import com.roxwin.imagefilter.filters.GPUImageSoftLightBlendFilter;
import com.roxwin.imagefilter.filters.GPUImageSourceOverBlendFilter;
import com.roxwin.imagefilter.filters.GPUImageSphereRefractionFilter;
import com.roxwin.imagefilter.filters.GPUImageSubtractBlendFilter;
import com.roxwin.imagefilter.filters.GPUImageSwirlFilter;
import com.roxwin.imagefilter.filters.GPUImageToneCurveFilter;
import com.roxwin.imagefilter.filters.GPUImageToonFilter;
import com.roxwin.imagefilter.filters.GPUImageTransformFilter;
import com.roxwin.imagefilter.filters.GPUImageTwoInputFilter;
import com.roxwin.imagefilter.filters.GPUImageVignetteFilter;
import com.roxwin.imagefilter.filters.GPUImageWeakPixelInclusionFilter;
import com.roxwin.imagefilter.filters.GPUImageWhiteBalanceFilter;
...
public class GPUImageFilterTools {
    ...
    static {
        filters.addFilter("Normal", FilterType.NORMAL);
...
//        filters.addFilter("Blend (Normal)", FilterType.BLEND_NORMAL);
    ...
    public static GPUImageFilter createFilterForType(final Context context, final FilterType type, float value) {
        switch (type) {
            case NORMAL:
                return new GPUImageNormalFilter();
            case CONTRAST:
            ...
            case SEPIA:
                return new GPUImageSepiaFilter(value);
            case SHARPEN:
...
//                return createBlendFilter(context, GPUImageNormalBlendFilter.class);
    ...
    public enum FilterType {
        NORMAL, CONTRAST, GRAYSCALE, SHARPEN, SEPIA, SEPIA2, SEPIA3, SEPIA4, SOBEL_EDGE_DETECTION, THREE_X_THREE_CONVOLUTION, FILTER_GROUP, EMBOSS, POSTERIZE, GAMMA, BRIGHTNESS, INVERT, HUE, PIXELATION,
    ...
    public static class FilterList {
        public HashMap<String, FilterType> filterMap = new HashMap<>();
        ...
        public HashMap<String, FilterType> getFilters() {
            return filterMap;
        }
    }
