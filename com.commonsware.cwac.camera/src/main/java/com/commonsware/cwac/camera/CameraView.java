...
public class CameraView extends ViewGroup implements AutoFocusCallback {
    ...
    /**
     * Lock the camera and preview to the provided orientation.  Passing in
     * SCREEN_ORIENTATION_UNSPECIFIED will re-enable automatic
     * orientation changes.
     *
     ...
     */
    public void lockToOrientation(int screenOrientation) {
